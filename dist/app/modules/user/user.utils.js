...
exports.generatedFacultyId = exports.findLastFacultyId = exports.generateStudentId = exports.findLastStudentId = void 0;
...
const generatedFacultyId = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let incrementedId = yield (parseInt(currentId) + 1)
        .toString()
        .padStart(5, '0');
